    ...
    function(Backbone, jquery, splunk_js_sdk) {
        var ExampleView = Backbone.View.extend({
            ...
            trigger_setup: function trigger_setup() {
                ...
                var macro_earliest_input_element = jquery("input[name=macro_earliest]");
                var macro_earliest = macro_earliest_input_element.val();
                macro_setup_options.earliest = this.sanitize_string(macro_earliest);

                var macro_latest_input_element = jquery("input[name=macro_latest]");
                var macro_latest = macro_latest_input_element.val();
                macro_setup_options.latest = this.sanitize_string(macro_latest);
            ...
            perform_setup: async function perform_setup(splunk_js_sdk, setup_options) {
                var app_name = "splunk_archive_plus_restore_app";
